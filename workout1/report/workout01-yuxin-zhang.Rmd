...
#Main Players
##Andre Iguodala
![Andre Iguodala](https://en.wikipedia.org/wiki/Andre_Iguodala#/media/File:Andre_Iguodala_2016_(cropped).jpg)
...
##Draymond Green
![Draymond Green](https://en.wikipedia.org/wiki/Draymond_Green#/media/File:Draymond_Green_against_Washington_(cropped).jpg)
...
##Kevin Durant
![Kevin Durant](https://en.wikipedia.org/wiki/Kevin_Durant#/media/File:Golden_State_Warriors_Small_Forward_Kevin_Durant_(cropped).jpg)
...
##Klay Thompson
![Klay Thompson](https://en.wikipedia.org/wiki/Klay_Thompson#/media/File:Klay_Thompson_vs._Jared_Dudley_(cropped).jpg)
...
##Stephen Curry
![Stephen Curry](https://en.wikipedia.org/wiki/Stephen_Curry#/media/File:Stephen_Curry_Shooting_(cropped).jpg)
Stephen Cooley is good at dribbling and jump shots, and shooting can cover the whole half. Excellent ball control, one-to-one through ball control to find out the mobile phone, a large number of three points from the dry pull. Because of his thin body, Kuri is not easy to enter the restricted area and lacks aggression.
...
- Andre Iguodala
The percentage of shooting is not high and the ball right in hand is low. But the two-point shooting rate is very high. Because the number of shots is small, not a conventional scoring point, the opponent's defensive force in these inputs is weak, so sometimes there will be vacancies, leading to a higher hit rate.

- Draymond Green
The percentage of shooting is very high and the ball right in hand is also high. And the shooting percentage is low. The main role of the team is to connect the team and defence.

- Kevin Durant
As the main offensive point, the offensive ability is strong, the number of effective attacks is large, especially the dichotomy, offensive firepower radiation all-round, is an all-round scoring point. What's more, his singles ability is worth mentioning.

- Klay Thompson
Thompson is the main three-point shooter in the team, and be  allocates more ball power, the end of offensive tactics, and the shooting percentage is very high.

- Stephen Curry
Curie is also the team's main three-point shooter, and is very similar with Thompson in shooting. The team allocates high ball power on him, and shooting percentage is very high.

##Analysis of Team's Overall Strength
With Kevin Durant's joining, the warriors can attack without dead corners. They can be said to be invincible and defensible. The Warriors have half of the dream team players, too many offensive points, Kevin Durant, Stephen Curie, Clay Thompson, Green are all reliable scoring points.
From the analysis of effective shooting, it is precisely because of the stable play of the five players that the Warriors have amazing results.Kevin Durant, Klay Thompson and Stephen Curry have the ability to shoot from the outside. Thompson and Berlin's breakthrough and scoring not only caused great harm to their opponents, but also created many opportunities for their teammates to shoot in the open.
